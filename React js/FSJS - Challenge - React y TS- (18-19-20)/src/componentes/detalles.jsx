        ...
        <Row>
          <>
            ...
            <Col xs={12} sm={12} lg={6} xl={6} style={{ textAlign: "center" }}>
              <h1 className="details-title">{product.titulo_producto}</h1>
              ...
              <div className="pagos justify-content-center text-center">
                <div className="price">
                  <h5>${product.precio_producto} </h5>
                  <div className="garantia"></div>
                  <button className="btn btn-danger"> SUMAR AL CARRITO</button>
                </div>
              </div>
            </Col>
            <Col>
              <div className="specs">
                ...
                <p>
                  ...
                  Aliquid eligendi quia eaque laborum necessitatibus, illum
                  velit, fuga ipsam exercitationem error reprehenderit odit?
                  Praesentium delectus placeat deleniti perspiciatis est
                  voluptas error?Lorem ipsum dolor sit amet consectetur
                  adipisicing elit. Quis sit provident deleniti recusandae in
                  facere reprehenderit molestiae velit nisi, iure, repellendus
                  magnam expedita ut quisquam perferendis quae dicta dolore
                  quasi.
                </p>
              </div>
            </Col>
